...
class Accident extends Base_Controller {
    ...
    public function bus_photo_confirm() {
        
    }
    
    public function bus_photo_upload() {
    ...
    public function medicine_photo_confirm() {
        
    }
    
    public function medicine_photo_upload() {
    ...
    public function natural_photo_confirm() {
        
    }
    
    public function natural_photo_upload() {
