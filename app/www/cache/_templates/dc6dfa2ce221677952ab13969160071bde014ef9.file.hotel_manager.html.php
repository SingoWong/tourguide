<?php /* Smarty version Smarty-3.1.16, created on 2014-11-24 18:02:42
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '18579325265470a3ed9bbb46-20098616',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_5470a3eda0d2c8_84456939',
  'variables' => 
  array (
    'rowset' => 0,
    'item' => 0,
...
<?php if ($_valid && !is_callable('content_5470a3eda0d2c8_84456939')) {function content_5470a3eda0d2c8_84456939($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/Users/singowong/Project/default/tourguide/core/libraries/Smarty/libs/plugins/modifier.date_format.php';
...
<input type="button" class="gm_t1_btn" value="续约饭店" onclick="self.location.href='index.php?ctr=syshotel';">
<input type="button" class="gm_t1_btn_alt_disabled" value="过期饭店" onclick="self.location.href='index.php?ctr=syshotel&act=expired';">
<input type="button" class="gm_t1_btn_alt_disabled" value="新增饭店" onclick="self.location.href='index.php?ctr=syshotel&act=edit';">
...
">
			<table border="0" width="100%" cellpadding="2" cellspacing="1">
				...
				<tr>
					<td colspan="2">饭店名称：<?php echo $_smarty_tpl->tpl_vars['item']->value->name;?>
</td>
