<?php /* Smarty version Smarty-3.1.16, created on 2014-11-28 18:55:32
...
<form class="gm_t1_form" id="reg_form" action="" method="GET">
	...
	<label class="v"><input id="start_date" type="text" name="start_date" value="" placeholder="日期开始"></label>
	<label class="v"><input id="end_date" type="text" name="end_date" value="" placeholder="日期结束"></label>
	<label class="v"><input id="contact_name" type="text" name="contact_name" value="" placeholder="导游"></label>
	<label class="v"><input id="code" type="text" name="code" value="" placeholder="团号"></label>
...
_'+day+'">'+
					...
					$.each(schedule,function(route,item){
						...
						case '3':
						case '4':
							html_day += '<tr><td>'+item['time']+'&nbsp;&nbsp;'+item['location']+'</td><td class="s_status">已订餐{钩}</td><td class="s_status">已订餐未确认{钩}</td><td class="s_status">已订餐已确认{钩}</td><td class="s_status">餐毕付款{钩}</td></tr>';
							break;
						case '5':
							html_day += '<tr><td>'+item['time']+'&nbsp;&nbsp;'+item['location']+'</td><td class="s_status">已订房{钩}</td><td class="s_status">CHKIN{钩}</td><td class="s_status">未结账{钩}</td><td class="s_status">CHKOUT{钩}</td></tr>';
							break;
						}
					});
